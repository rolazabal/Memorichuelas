class Tome {
	...
	static strings = {
		...
		name: ["Name", "Nombre"],
		set_name_text: ["Enter a name", "Nombra la colleccion"],
		...
		user_delete_blurb: ["You will not be able to recover your account or sets once deleted.", "No vas a poder recuperar tu cuenta ni tus collecciones despues de borrar."],
		login: ["Log in", "Entrar"],
		logout: ["Log out", "Salir"],
		login_text: ["Or log in to continue:", "O inicia una sesion para continuar:"],
		username: ["Username", "Nombre de usuario"],
		username_text: ["Enter a username 1-10 characters in length.", "Entra nombre de usuario de 1-10 letras."],
        ...
        set_delete_blurb: ["You will not be able to recover this set or your score once deleted.", "No vas a poder recuperar la colleccion ni tu puntuacion despues de borrar."],
		share: ["Share", "Compartir"],
        set_share_text: ["Share this ID to allow other users to clone this set!", "Comparte este numero con otros usuarios para que puedan clonar la colleccion!"],
		rename: ["Rename", "Renombrar"],
        set_rename_text: ["Rename set", "Renombrar la colleccion"],
		clone: ["Clone", "Clonar"],
